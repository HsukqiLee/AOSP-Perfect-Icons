...
```powershell
.\gradlew.bat :app:assembleRelease "-PICONPACK_COMPILE_SDK=35" "-PICONPACK_TARGET_SDK=35" "-PICONPACK_STORE_FILE=release.jks" "-PICONPACK_STORE_PASSWORD=<your-keystore-password>" "-PICONPACK_KEY_ALIAS=perfecticons" "-PICONPACK_KEY_PASSWORD=<your-key-password>"
```
...
> ICONPACK_STORE_PASSWORD=<your-keystore-password>
